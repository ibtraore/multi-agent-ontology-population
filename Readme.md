...
![Alt text](Images/ADHD_Semantic_Model.jpeg)

---

## The proposed Multi-Agent System

![Alt text](Images/Multi_agents_approach.jpg)

---

## Results of Knowledge extraction

The experimental evaluation is based on data from three ADHD-diagnosed patients.
...
- [Multi_Agent](Multi_Agent) :  Contains the outputs and evaluation results of our multi-agent system.
    - [Profile Crew](Multi_Agent/Profile_Crew) :Stores the outputs generated by the agent team responsible for extracting data from the Profile module. Organized by the three use cases, each subfolder includes the outputs for the three tested models: DeepSeek, Mistral, and LLama.
    - [Module Crew](Multi_Agent/Module_Crew/) : Stores the outputs generated by the agent team responsible for extracting data from the other ontology modules. Similarly, the results are organized by the three use cases and include outputs for DeepSeek, Mistral, and LLama.
